...
async function loadDynamicSidebar() {
    try {
        ...
        container.innerHTML = '<p id="sidebar-error-text">Error loading content: </p>';
        document.getElementById('sidebar-error-text').appendChild(document.createTextNode(errorMsg));
    }
}
animate();
